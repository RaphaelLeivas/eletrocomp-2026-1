...
% ---
\begin{anexosenv}
    \chapter{Código Exercício 5.2}\label{cap:ex5-2-codigo}
    ...
    \chapter{Código Exercício 7.1}\label{cap:ex7-1-codigo}
    \begin{lstlisting}[language=Python, breaklines=true, basicstyle=\tiny]
    ...
    \chapter{Código Exercício 7.2}\label{cap:ex7-2-a-codigo}
    \begin{lstlisting}[language=Python, breaklines=true, basicstyle=\tiny]
    import numpy as np
    import matplotlib.pyplot as plt
    import seaborn as sns
