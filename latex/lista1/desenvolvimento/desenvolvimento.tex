...
Pelo teorema do divergente, sabemos que
...
\noindent mas sabemos também que 
...
\[
\int_{\Omega} \left( f \nabla^2 g + \nabla f \cdot \nabla g \right) d\Omega
= \int_{\partial \Omega} f \frac{\partial g}{\partial n} \, dS
\]

\section{Item (b)}

Troca $f$ pro $g$ na respota do Item (a)

\[
\int_{\Omega} \left( g \nabla^2 f + \nabla g \cdot \nabla f \right) d\Omega
= \int_{\partial \Omega} g \frac{\partial f}{\partial n} \, dS
\]

Agora subtrai a equação do Item (a) da equação obtida
...
\[
\int_{\Omega} f \nabla^2 g - g \nabla^2 f d\Omega
= \int_{\partial \Omega} f \frac{\partial g}{\partial n} - g \frac{\partial f}{\partial n} \, dS
\]
...
Se $\sigma \to \infty$, então precisamos de $\mathbf{E} = 0 $
dentro do condutor para 
que $\mathbf{J}$ seja finita. Logo, as cargas ficam todas na superfície 
externa do condutor, de modo que a corrente flui apenas na superfície. 

Usando a condição de fronteira obtida na Questão 5,
temos que a carga superficial $\rho_s$ é dada pela 
carga que flui no condutor.

\chapter{Questão 8}\label{cap:q8}

Definições dos potencias
...
Substitui nas equações de Maxwell

\begin{align*}
\nabla \cdot -\nabla \phi - \frac{\partial \mathbf{A}}{\partial t} &= \frac{\rho}{\varepsilon} \\
\nabla \cdot \nabla \times \mathbf{A} &= 0 \\
\nabla \times -\nabla \phi - \frac{\partial \mathbf{A}}{\partial t} &= -\frac{\partial \nabla \times \mathbf{A}}{\partial t} \\
\nabla \times \nabla \times \mathbf{A} &= \mu \mathbf{J} + \mu \varepsilon \frac{\partial \mathbf{E}}{\partial t}
\end{align*}

\textcolor{red}{Dúvida: como avançar?}

\chapter{Questão 9}\label{cap:q9}

Vamos considerar o caso simples no vácuo
...
Expande os rotacionais, zerando as derivadas em $z$

\[
\nabla \times \mathbf{E} =
\left[
\frac{\partial E_z}{\partial y} \quad
-\frac{\partial E_z}{\partial x} \quad
...
\nabla \times \mathbf{H} =
\left[
\frac{\partial H_z}{\partial y} \quad
-\frac{\partial H_z}{\partial x} \quad
\frac{\partial H_y}{\partial x} - \frac{\partial H_x}{\partial y}
\right]
\]

Igualando componente a componente, temos 6 equações: 
...
\frac{\partial E_y}{\partial x} - \frac{\partial E_x}{\partial y}
&= -\mu \frac{\partial H_z}{\partial t}
\end{align*}

\begin{align*}
\frac{\partial H_z}{\partial y} &= \varepsilon \frac{\partial E_x}{\partial t} \\
-\frac{\partial H_z}{\partial x} &= \varepsilon \frac{\partial E_y}{\partial t} \\
\frac{\partial H_y}{\partial x} - \frac{\partial H_x}{\partial y}
&= \varepsilon \frac{\partial E_z}{\partial t}
\end{align*}

No modo TE, fazemos $E_z = 0$, 

\begin{align*}
0 &= -\mu \frac{\partial H_x}{\partial t} \\
0 &= -\mu \frac{\partial H_y}{\partial t} \\
\frac{\partial E_y}{\partial x} - \frac{\partial E_x}{\partial y}
&= -\mu \frac{\partial H_z}{\partial t} \\
\frac{\partial H_z}{\partial y} &= \varepsilon \frac{\partial E_x}{\partial t} \\
-\frac{\partial H_z}{\partial x} &= \varepsilon \frac{\partial E_y}{\partial t} \\
...
Mesma ideia para o TM, fazendo $H_z = 0$.
